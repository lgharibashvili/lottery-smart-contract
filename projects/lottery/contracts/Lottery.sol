...
contract Lottery is ReentrancyGuard, ILottery, Ownable {
     ...
     * @param _currencyTokenAddress: address of the currency token
     * @param _randomGeneratorAddress: address of the RandomGenerator contract used to work with ChainLink VRF
     */
    constructor(address _currencyTokenAddress, address _randomGeneratorAddress) {
        currency = IERC20(_currencyTokenAddress);
        ...
        nonReentrant
    {
        ...
        // Calculate number of currency tokens to this contract
        ...
        // Transfer currency tokens to this contract
        currency.safeTransferFrom(address(msg.sender), address(this), amountToTransfer);
        ...
        nonReentrant
    {
        ...
        for (uint32 i = 0; i < 6; i++) {
            ...
            if (
                ...
                if (_lotteries[_lotteryId].rewardsBreakdown[j] != 0) {
                    _lotteries[_lotteryId].pricePerBracket[j] =
                ...
                // A. No price to distribute, they are added to the amount to withdraw to treasury address
            } else {
                _lotteries[_lotteryId].pricePerBracket[j] = 0;
        ...
        currency.safeTransfer(treasuryAddress, amountToWithdrawToTreasury);
    ...
    function injectFunds(uint256 _lotteryId, uint256 _amount) external override onlyOwnerOrInjector {
        ...
        currency.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function startLottery(
        ...
        _lotteries[currentLotteryId] = LotteryInfo({
            ...
            pricePerBracket: [uint256(0), uint256(0), uint256(0), uint256(0), uint256(0), uint256(0)],
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(currency), "Cannot be lottery currency");
    ...
    function _calculateRewardsForTicketId(
        ...
        if (transformedWinningNumber == transformedUserNumber) {
            return _lotteries[_lotteryId].pricePerBracket[_bracket];
        } else {
            return 0;
        }
    }
